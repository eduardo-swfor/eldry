...
export default function DialogAlerta({conteudo, sair = null, visivel = false}) {
        ...
        >
          <div className='w-11/12 md:w-1/3 my-6 mx-auto'>
            ...
            `}>
              {/*header*/}
              <div className={`
                flex items-start justify-between p-2 bg-yellow-200
                rounded-t shadow-sm
              `}>
                <div className='flex text-black'>
                  {IconeExclamacao()}
                  <Titulo className='ml-2 text-black'>
                    Alerta
                  </Titulo>
                </div>
                <button className={`
