...
export default function EdicaoMensagem({objEditado, voltar, gravar}) {
    ...
    function validaDados() {
        ...
        if (!vo.descricao || !vo.dataInicio || !vo.dataFim || !vo.arquivo) {
        ...
        <div className='px-2'>
            <div className='flex flex-wrap w-full h-full'>
                <div className='flex flex-row w-full justify-between'>
                    <Subtitulo>Alteração/Inclusão de mensagens</Subtitulo>
                    <div className='flex'>
                        <BotaoVoltar 
                            className='mr-3'
                            onClick={voltar}
                ...
                <div className='flex flex-col w-full md:flex-row'>
                    ...
                    <DateInput 
                        ...
                        className='w-full md:w-1/5 md:ml-2' 
                        value={vo.dataInicio}
                        onChange={valor => { 
                            setVo({...vo, dataInicio: valor})
                        }}
                    />
                    <DateInput 
                        required
                ...
                <input 
                    ...
                    onChange={event=>{ 
                        ...
                        if (file?.size > 1e6) {
                            ...
                            alerta('O arquivo não pode ter mais que 1MB')
                        } else {
