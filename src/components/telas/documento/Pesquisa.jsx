...
export default function PesquisaDocumento({novo, dados, excluir}) {
  ...
  return (
      <div className='px-2'>
          ...
          <div className='flex flex-row w-full'>
              <Subtitulo className='flex-grow'>Pesquisa de documentos</Subtitulo>
              <BotaoNovo 
                  onClick={() => {
                    novo()
                  }} 
          ...
          <TabelaDados 
              ...
              propriedades={[
                ...
                {nome: 'arquivo.nomeOriginal', tipo: 'string', titulo: 'Arquivo' }, 
              ]} 
              titulo='Pesquisa'
