...
apiRoute.post(async (req, res) => {    
    ...
    const retorno = await incluiRegistro(Colecoes.MENSAGENS, mensagem, email, req)
    const novoVo = await buscaPeloId(Colecoes.MENSAGENS, retorno.insertedId)
